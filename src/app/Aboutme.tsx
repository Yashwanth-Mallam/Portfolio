    ...
    <div className="flex justify-center items-center p-6">
      <div className="max-w-3xl w-full bg-gray rounded-lg shadow-xl p-8">
        ...
        <p className="text-lg  leading-relaxed mb-4">
          ...
          projects. I’ve developed a strong foundation in building dynamic web
          applications, from creating intuitive user interfaces with React.js to
          understanding the intricacies of backend logic with Node.js. My goal
          is to write clean, efficient, and scalable code while constantly
          improving my skills.
        </p>
        <p className="text-lg  leading-relaxed mb-4">
          ...
          exploring potential collaborations, don’t hesitate to reach out. Let's
          work together to bring creative concepts to life!
        </p>
      </div>
    </div>
  );
